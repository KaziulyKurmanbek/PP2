...
# В задачах этого листка нельзя использовать массивы и динамическую память - только переменные! 
# Входные данные (кроме одной задачи) нужно читать до появления числа 0, означающего конец последовательности. 
